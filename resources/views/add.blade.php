        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="my-form" onsubmit="return validform()" action="{{route('staff.add')}}"
                              method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="present_address" class="col-md-4 col-form-label text-md-right">Số
                                    CMND</label>
                                <div class="col-md-6">
                                    <input type="text" id="present_address" class="form-control" name="ID_number">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Ngày
                                    sinh</label>
                                <div class="col-md-6">
                                    <input type="date" id="permanent_address" class="form-control" name="dob">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="nid_number" class="form-control" name="address">
                                </div>
                            </div>
